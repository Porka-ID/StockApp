...
class Spinbox(ctk.CTkFrame):
    def __init__(self, *args,
        ...
        self.valueEntry = ctk.StringVar()
        self.entry = ctk.CTkEntry(self, width=width-(70), height=height-6, border_width=0, textvariable=self.valueEntry)
        self.entry.grid(row=0, column=1, columnspan=1, padx=3, pady=3, sticky="nsew")
        self.valueEntry.set(self.start_value)
